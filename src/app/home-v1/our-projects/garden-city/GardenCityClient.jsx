    ...
    <div style={{ background: C.bgWhite }}>
      ...
      <section className="relative overflow-hidden py-20"
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10 text-center">
          ...
          >
            <a href="/home-v1/our-projects" className="hover:text-green-400 transition-colors">Our Projects</a>
            <span>/</span>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "Price", value: "₹1,175/sqft" },
                { label: "Location", value: "Off NH 207" },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <table className="w-full text-[13px] border-collapse">
              <thead>
                <tr style={{ background: `linear-gradient(90deg, ${C.green}, ${C.greenMid})` }}>
              ...
              <tbody>
                {[
                  { dim: "30×40", sqft: "1200sqft", price: "1175/-sqft", total: "14,10,000/-", down: "4,23,000",  i1: "3,29,000",  i2: "3,29,000",  i3: "3,29,000"  },
                  { dim: "30×50", sqft: "1500sqft", price: "1175/-sqft", total: "17,62,500/-", down: "5,39,550",  i1: "4,11,250",  i2: "4,11,250",  i3: "4,11,250"  },
                  { dim: "40×60", sqft: "2400sqft", price: "1175/-sqft", total: "28,20,000/-", down: "8,46,000",  i1: "6,58,000",  i2: "6,58,000",  i3: "6,58,000"  },
                  { dim: "50×80", sqft: "4000sqft", price: "1175/-sqft", total: "47,00,000/-", down: "14,10,000", i1: "10,96,666", i2: "10,96,666", i3: "10,96,666" },
                ].map((row, i) => (
                  <motion.tr key={row.dim}
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: i * 0.08 }}
                    style={{ background: i % 2 === 0 ? "#f0fdf4" : "#ffffff", borderBottom: `1px solid ${C.border}` }}>
                    ...
                    <td className="px-4 py-4 font-semibold" style={{ color: C.green }}>{row.price}</td>
      ...
      <section className="px-6 lg:px-10 py-20" style={{ background: C.bgWhite }}>
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            {/* English */}
            <div>
              <h4 className="font-bold text-[15px] mb-5 pb-2" style={{ color: C.greenDark, borderBottom: `2px solid ${C.border}` }}>English</h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              className="rounded-2xl p-8" style={{ background: "#f0fdf4", border: `1px solid ${C.border}` }}>
              <h4 className="font-extrabold text-[15px] mb-6 tracking-[0.12em] uppercase flex items-center gap-2" style={{ color: C.greenDark }}>
              ...
              <ol className="flex flex-col gap-2.5">
                {["135 Acres Brigade Orchards","Chanakya University","Sattva Park Cubix","Airport T2","Chinmayee Public School","METRO Phase 2A","KIADB","Akash Medical Institute","D Mart","Devanahalli Business Park","Devanahalli Railway Station","Proposed Embassy IT Park"].map((item, i) => (
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}
              ...
              <ol className="flex flex-col gap-2.5">
                {["80ft Main Road","Water Connection","Underground Sewage Connection","Drainage System","Underground Electricity","Entrance Arch","Sewage Treatment Plant","Street Lights","Amphitheater","Theme Parks","Club House","Swimming Pool"].map((item, i) => (
                  <motion.li key={i} initial={{ opacity: 0, x: 8 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.04 }}
                    className="flex items-center gap-3 text-[13px]" style={{ color: C.body }}>
      ...
      <section className="px-6 lg:px-10 py-16 text-center"
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          ...
          <motion.a href="/home-v1/our-projects/north-metro-city"
            whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.96 }}
      ...
      <footer style={{ background: C.bgSection, borderTop: `1px solid ${C.border}` }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-5 text-[12px]" style={{ color: C.muted }}>
            ...
            <a href="/home-v1/our-projects/north-metro-city" className="hover:text-green-700 transition-colors">North Metro City</a>
